...
public function Print_Table_Content($students_data)
{
    ...
    foreach ($students_data as $student) {
        ...
        echo '<a href="index.php?id=' . $id . '" class="student-link" style="color: #0066cc; text-decoration: underline; font-weight: bold;">';
        ...
        echo '<td class="info-table__cell">';
        echo '<a href="index.php?action=delete&id=' . $id . '" style="color: red; text-decoration: none; font-weight: bold;">Удалить</a>';
        echo '</td>';
        echo '</tr>';
    }
}
